...
from src.dataset.dataset_distraction_onepath_spilt import WSCMDataset
from src.model.cnn_distraction_onepath_split import WCDMACNNDISTRACT
...
def get_args():
    ...
    parser.add_argument('--model_path', type=str, default='checkpoints_fraction_delay/100k-add-distraction/cnn/best_model.pth', help='模型路径')
