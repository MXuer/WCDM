...
from src.dataset.dataset_1path import WSCMDataset
...
def get_args():
    ...
    parser.add_argument('--data_dir', type=str, default='/data/duhu/WCDM/data/train/uniform', help='训练数据目录')
    ...
    parser.add_argument('--log_dir', type=str, default='logs_uniform/100k_3to1', help='TensorBoard日志目录')
    parser.add_argument('--save_dir', type=str, default='checkpoints_uniform/100k_3to1', help='模型保存目录')
