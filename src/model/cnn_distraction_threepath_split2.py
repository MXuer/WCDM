...
class WCDMACNNDISTRACT2(nn.Module):
    def __init__(self, input_height=4, input_width=64, input_channels=3, output_size=1):
        ...
        self.conv_layers = nn.Sequential(
            ...
            # 第二层：减小卷积核高度避免尺寸过小
            nn.Conv2d(64, 128, kernel_size=(2, 8), stride=(1, 2), padding=(0, 1)),  # 高度方向使用1x卷积
            nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Dropout(0.2),
            ...
            # 第五层：减少输出通道
            nn.Conv2d(128, 64, kernel_size=(1, 2), stride=(1, 1), padding=(0, 0)),
            nn.LeakyReLU(0.1),
