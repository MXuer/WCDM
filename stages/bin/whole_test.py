...
def get_args():
    ...
    parser.add_argument('--test_dir', type=str, default='/data/duhu/WCDM/data_stages/layleigh_channel/fraction_delay/SF16_test_dataSet_160Bit_HDF520250714_145955', help='测试数据目录')
    parser.add_argument('--batch_size', type=int, default=256, help='批大小')
    parser.add_argument('--data-model', type=str, default='checkpoints_stage_mix/dunet/best_model.pth', help='模型路径')
...
def main():
    ...
    test_dirs = list(Path(args.test_dir).glob('*'))
